...
<script type='text/javascript' src='/comm/js/script.js?v=1774840792'></script>
...
<link rel="stylesheet" type="text/css" href="/comm/css/sub.css?v=1774840792" />
...
<!--[e] 모바일 menuArea -->
  		...
  		<!-- Visual -->
		<div id="visual">
			<div class="bg subtop_contact"></div>
			<h2>CONTACT<span>For any inquiries, please contact us.</span></h2>
		</div> 
		<!--//Visual -->
...
<div class="tab_cont basicCont2 sub_effect">
   <div class="tabBtn">
      <ul>
         <li><a data-id="con1" class="on" target="_self"  onclick="resizeMap()">CAREERS</a></li>
         <li><a data-id="con2" target="_self"  onclick="relayout()">INQUIRY</a></li>
         </ul>
      </div>
	  
	  
   <div class="tabCont_in">
   <div class="contact_cont conBox on" id="con1">
   <h2 class="on">CAREERS</h2>
   <div class="border_box">
      <div class="txt">
         <p>재무자문(FAS) 관련 근무 경험을 보유한 경력직원부터 KICPA(유예생 포함)/ AICPA 및 재무자문(FAS) 업무에 관심있는 예비 신입직원까지 회계법인 숲과 함께 재무자문 전문가의 길을 걸어가고자 하는 분들의 지원을 받고 있습니다.</p>
      </div>
      <ul>
         <li>
            <strong>채용 공고 :</strong>
            <p>경력직</p>
            <p>
               <font class="ls0">Internship</font> (KICPA 유예생)
            </p>
         </li>
         <li>
            <strong>근무 위치 :</strong>서울시 강남구 도산대로 544, 5층 (청담동)
         </li>
         <li>
            <strong>제출 방법</strong>
            <dl class="line_list">
               <dd>지원은 이메일로 받습니다 : <font class="ls0">FORESTAC@forestac.co.kr</font></dd>
               <dd>이메일 제목 : <font class="ls0">“[FOREST Application] - Last Name_First Name”</font></dd>
               <dd>제출 서류 : 자기소개서 <font class="ls0">(Cover Letter)</font> 및 이력서 <font class="ls0">(Resume)</font></dd>
            </dl>
         </li>
      </ul>
   </div>
   <div class="center">
      <a href="https://www.kicpa.or.kr/portal/default/kicpa/gnb/kr_pc/menu05/menu09.page" target="_blank">Read More</a>
   </div>
</div>
<link rel="stylesheet" type="text/css" href="/comm/css/sub.css" /><!--       <div class="contact_cont conBox on" id="con1">
         <h2 class="on">CAREERS</h2>
         <div class="border_box">
            <div class="txt">
               <p>재무자문(FAS) 관련 근무 경험을 보유한 경력직원부터 KICPA(유예생 포함)/ AICPA 및 재무자문(FAS) 업무에 관심있는 예비 신입직원까지 회계법인 숲과 함께 재무자문 전문가의 길을 걸어가고자 하는 분들의 지원을 받고 있습니다.</p>
            ...
            <ul>
               <li><strong>채용 공고 :</strong>
                  <p>경력직</p>
                  <p><font class="ls0">Internship</font> (KICPA 유예생)
                  </p>
                  </li>
               <li><strong>근무 위치 :</strong>서울시 강남구 도산대로 544, 5층 (청담동)
               </li>
               <li><strong>제출 방법</strong>
                  <dl class="line_list">
                     <dd>지원은 이메일로 받습니다 : <font class="ls0">FORESTAC@forestac.co.kr </font></dd>
                     <dd>이메일 제목 : <font class="ls0">“[FOREST Application] - Last Name_First Name”</font></dd>
                     <dd>제출 서류 : 자기소개서 <font class="ls0">(Cover Letter)</font> 및 이력서 <font class="ls0">(Resume)</font></dd>
         ...
         <div class="center"><a href="https://www.kicpa.or.kr/portal/default/kicpa/gnb/kr_pc/menu05/menu09.page" target="_blank">Read More</a></div>
         </div> -->
		 
		 
		 
		 
      <div class="inquiry_cont conBox" id="con2">
         <h2>INQUIRY</h2>
         <div class="location_cont">

<div id="daumRoughmapContainer1661820105707" class="root_daum_roughmap root_daum_roughmap_landing" style="width:100%;"></div>

<script charset="UTF-8" class="daum_roughmap_loader_script" src="../assets/ssl.daumcdn.net/dmaps/map_js_init/roughmapLoader.js"></script>

<script charset="UTF-8">
	new daum.roughmap.Lander({
		"timestamp" : "1661820105707",
		"key" : "2bixh",
	}).render();
</script>
            ...
            <div class="location_info">
               <ul>
                  <li><span><img src="/sub/img/tel.png" alt="TELEPHONE" />TELEPHONE</span>02-6954-2500                  </li>
                  <li><span><img src="/sub/img/email.png" alt="E-MAIL" />E-MAIL</span>FORESTac@forestac.co.kr                  </li>
                  <li><span><img src="/sub/img/address.png" alt="HEAD OFFICE" />HEAD OFFICE</span>서울 강남구 도산대로 544, 5층 (청담동)                  </li>
                  </ul>
               </div>
            <a href="http://kko.to/DeTgaRVry" target="_blank" class="mapBtn">Map</a></div>
         </div>
      </div>
...
<script>
	    ...
	    $(function(){
						...
						$(".tabBtn li a").click(function(){ 
								// 현재 선택되어있던 메뉴들을 초기화함
								$(".tabBtn li a").removeClass('on');
								$(".title h2").removeClass('on');
								$(".tab_cont .conBox").removeClass('on');
...
var mapContainer = document.getElementById('daumRoughmapContainer1661820105707'), // 지도를 표시할 div 
    mapOption = { 
...
function resizeMap() {
    var mapContainer = document.getElementById('daumRoughmapContainer1661820105707');
}
