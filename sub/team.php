...
<script type='text/javascript' src='/comm/js/script.js?v=1774840761'></script>
...
<link rel="stylesheet" type="text/css" href="/comm/css/sub.css?v=1774840761" />
...
<!--[e] 모바일 menuArea -->
  		...
  		<!-- Visual -->
		<div id="visual">
			<div class="bg subtop_team"></div>
			<h2>TEAM<span>PROFESSIONALS</span></h2>
		</div> 
		<!--//Visual -->
...
<div class="basicCont2 team_cont sub_effect"><script Language="JavaScript" src="/admin/js/lib2.js"></script>
<link href="/admin/bbs/skin/teamBasic/style.css" rel="stylesheet" type="text/css">
<!-- 카테고리 -->
...
<dl>
		<a href="/sub/team.php?ptype=view&idx=20&page=1&code=team">
	<dt><img src="/admin/bbs/skin/teamBasic/image/blank_img.png" style="background-image:url('/admin/data/bbs/team/M2207260458183_1.jpg')" alt="김재훈" /><div class="tit"><small class="eng">Managing Partner / CEO</small><h4>김재훈</h4></div></dt>
	<dd>
		<div>
			 <ul>
				 <li>All Industries</li>
				 <li>jaehoonkim@forestac.co.kr </li>
			 </ul>
...
<dl>
		<a href="/sub/team.php?ptype=view&idx=101&page=1&code=team">
	<dt><img src="/admin/bbs/skin/teamBasic/image/blank_img.png" style="background-image:url('/admin/data/bbs/team/M2207190530343_1.jpg')" alt="임양우" /><div class="tit"><small class="eng">Leader / Partner</small><h4>임양우</h4></div></dt>
	<dd>
		<div>
			 <ul>
				 <li>Valuation of early-stage start-up companies</li>
				 <li>yangwooim@forestac.co.kr</li>
			 </ul>
			 <span class="more">Read More</span>
		</div>
	</dd>
...
<dl>
		<a href="/sub/team.php?ptype=view&idx=102&page=1&code=team">
	<dt><img src="/admin/bbs/skin/teamBasic/image/blank_img.png" style="background-image:url('/admin/data/bbs/team/M2207190546259_1.jpg')" alt="전정수" /><div class="tit"><small class="eng">Leader / Partner</small><h4>전정수</h4></div></dt>
	<dd>
		<div>
			 <ul>
				 <li>Valuation and M&A advisory service</li>
				 <li>jungsujun@forestac.co.kr </li>
			 </ul>
			 <span class="more">Read More</span>
		</div>
	</dd>
...
<dl>
		<a href="/sub/team.php?ptype=view&idx=186&page=1&code=team">
	<dt><img src="/admin/bbs/skin/teamBasic/image/blank_img.png" style="background-image:url('/admin/data/bbs/team/M2207260356506_1.jpg')" alt="이태환" /><div class="tit"><small class="eng">Leader/Partner</small><h4>이태환</h4></div></dt>
	<dd>
		<div>
			 <ul>
				 <li>Valuation and Due Diligence </li>
				 <li>taehwanlee@forestac.co.kr </li>
			 </ul>
			 <span class="more">Read More</span>
		</div>
	</dd>
...
<dl>
		<a href="/sub/team.php?ptype=view&idx=185&page=1&code=team">
	<dt><img src="/admin/bbs/skin/teamBasic/image/blank_img.png" style="background-image:url('/admin/data/bbs/team/M2207260332132_1.jpg')" alt="권오희" /><div class="tit"><small class="eng">Leader</small><h4>권오희</h4></div></dt>
	<dd>
		<div>
			 <ul>
				 <li>Valuation and M&A advisory service</li>
				 <li>ohheekwon@forestac.co.kr </li>
			 </ul>
			 <span class="more">Read More</span>
		</div>
	</dd>
...
<dl>
		<a href="/sub/team.php?ptype=view&idx=187&page=1&code=team">
	<dt><img src="/admin/bbs/skin/teamBasic/image/blank_img.png" style="background-image:url('/admin/data/bbs/team/M2207260413005_1.jpg')" alt="권순근" /><div class="tit"><small class="eng">Leader</small><h4>권순근</h4></div></dt>
	<dd>
		<div>
			 <ul>
				 <li>Valuation and M&A advisory service</li>
				 <li>sgkwon@forestac.co.kr </li>
			 </ul>
			 <span class="more">Read More</span>
		</div>
	</dd>
...
<dl>
		<a href="/sub/team.php?ptype=view&idx=184&page=1&code=team">
	<dt><img src="/admin/bbs/skin/teamBasic/image/blank_img.png" style="background-image:url('/admin/data/bbs/team/M2207260312108_1.jpg')" alt="이장원" /><div class="tit"><small class="eng">Leader</small><h4>이장원</h4></div></dt>
	<dd>
		<div>
			 <ul>
				 <li>Valuation and M&A advisory service</li>
				 <li>jangwonlee@forestac.co.kr </li>
			 </ul>
			 <span class="more">Read More</span>
		</div>
	</dd>
...
<dl>
		<a href="/sub/team.php?ptype=view&idx=188&page=1&code=team">
	<dt><img src="/admin/bbs/skin/teamBasic/image/blank_img.png" style="background-image:url('/admin/data/bbs/team/M2207260456003_1.jpg')" alt="권호유" /><div class="tit"><small class="eng">Associate Leader</small><h4>권호유</h4></div></dt>
	<dd>
		<div>
			 <ul>
				 <li>Valuation and M&A advisory service</li>
				 <li>hoyukwon@forestac.co.kr </li>
			 </ul>
			 <span class="more">Read More</span>
		</div>
	</dd>
...
<dl>
		<a href="/sub/team.php?ptype=view&idx=26&page=1&code=team">
	<dt><img src="/admin/bbs/skin/teamBasic/image/blank_img.png" style="background-image:url('/admin/data/bbs/team/M2207260501552_1.jpg')" alt="민영석​" /><div class="tit"><small class="eng">Senior Manager</small><h4>민영석​</h4></div></dt>
	<dd>
		<div>
			 <ul>
				 <li>Platform, Industrial Market </li>
				 <li>youngsukmin@forestac.co.kr </li>
			 </ul>
			 <span class="more">Read More</span>
		</div>
	</dd>
...
<dl>
		<a href="/sub/team.php?ptype=view&idx=25&page=1&code=team">
	<dt><img src="/admin/bbs/skin/teamBasic/image/blank_img.png" style="background-image:url('/admin/data/bbs/team/M2207260500519_1.jpg')" alt="정일현" /><div class="tit"><small class="eng">Senior Manager​</small><h4>정일현</h4></div></dt>
	<dd>
		<div>
			 <ul>
				 <li>Due Diligence and Valuation </li>
				 <li>ilhyunjung@forestac.co.kr </li>
			 </ul>
			 <span class="more">Read More</span>
		</div>
	</dd>
...
<dl>
		<a href="/sub/team.php?ptype=view&idx=24&page=1&code=team">
	<dt><img src="/admin/bbs/skin/teamBasic/image/blank_img.png" style="background-image:url('/admin/data/bbs/team/M2207260459262_1.jpg')" alt="한호석" /><div class="tit"><small class="eng">Senior Manager​</small><h4>한호석</h4></div></dt>
	<dd>
		<div>
			 <ul>
				 <li>Due Diligence and Valuation </li>
				 <li>hoseokhan@forestac.co.kr </li>
			 </ul>
			 <span class="more">Read More</span>
		</div>
	</dd>
...
<dl>
		<a href="/sub/team.php?ptype=view&idx=219&page=1&code=team">
	<dt><img src="/admin/bbs/skin/teamBasic/image/blank_img.png" style="background-image:url('/admin/data/bbs/team/M2411200437002_1.jpg')" alt="소정현" /><div class="tit"><small class="eng">Senior Manager​</small><h4>소정현</h4></div></dt>
	<dd>
		<div>
			 <ul>
				 <li>Due Diligence and Valuation</li>
				 <li>jeonghyunso@forestac.co.kr </li>
			 </ul>
			 <span class="more">Read More</span>
		</div>
	</dd>
...
<dl>
		<a href="/sub/team.php?ptype=view&idx=282&page=1&code=team">
	<dt><img src="/admin/bbs/skin/teamBasic/image/blank_img.png" style="background-image:url('/admin/data/bbs/team/M2410310146015_1.jpg')" alt="정동준" /><div class="tit"><small class="eng">Manager</small><h4>정동준</h4></div></dt>
	<dd>
		<div>
			 <ul>
				 <li>Due Diligence</li>
				 <li>dongjunjung@forestac.co.kr</li>
			 </ul>
			 <span class="more">Read More</span>
		</div>
	</dd>
...
<dl>
		<a href="/sub/team.php?ptype=view&idx=281&page=1&code=team">
	<dt><img src="/admin/bbs/skin/teamBasic/image/blank_img.png" style="background-image:url('/admin/data/bbs/team/M2410310134134_1.jpg')" alt="김진권" /><div class="tit"><small class="eng">Professional</small><h4>김진권</h4></div></dt>
	<dd>
		<div>
			 <ul>
				 <li>IT, Media & Telecommunications</li>
				 <li>jinkwonkim@forestac.co.kr</li>
			 </ul>
			 <span class="more">Read More</span>
		</div>
	</dd>
...
<dl>
		<a href="/sub/team.php?ptype=view&idx=286&page=1&code=team">
	<dt><img src="/admin/bbs/skin/teamBasic/image/blank_img.png" style="background-image:url('/admin/data/bbs/team/M2411181006513_1.jpg')" alt="우나영" /><div class="tit"><small class="eng">Professional</small><h4>우나영</h4></div></dt>
	<dd>
		<div>
			 <ul>
				 <li>Valuation</li>
				 <li>nayoungwoo@forestac.co.kr</li>
			 </ul>
			 <span class="more">Read More</span>
		</div>
	</dd>
...
<dl>
		<a href="/sub/team.php?ptype=view&idx=295&page=1&code=team">
	<dt><img src="/admin/bbs/skin/teamBasic/image/blank_img.png" style="background-image:url('/admin/data/bbs/team/M2511070533027_1.jpg')" alt="고준희" /><div class="tit"><small class="eng">Professional</small><h4>고준희</h4></div></dt>
	<dd>
		<div>
			 <ul>
				 <li>Cross-border</li>
				 <li>junheeko@forestac.co.kr</li>
			 </ul>
			 <span class="more">Read More</span>
		</div>
	</dd>
...
<dl>
		<a href="/sub/team.php?ptype=view&idx=283&page=1&code=team">
	<dt><img src="/admin/bbs/skin/teamBasic/image/blank_img.png" style="background-image:url('/admin/data/bbs/team/M2410310155371_1.jpg')" alt="김지언" /><div class="tit"><small class="eng">Professional</small><h4>김지언</h4></div></dt>
	<dd>
		<div>
			 <ul>
				 <li>Leisure, IT, BIO Industries</li>
				 <li>jieonkim@forestac.co.kr</li>
			 </ul>
			 <span class="more">Read More</span>
		</div>
	</dd>
...
<dl>
		<a href="/sub/team.php?ptype=view&idx=288&page=1&code=team">
	<dt><img src="/admin/bbs/skin/teamBasic/image/blank_img.png" style="background-image:url('/admin/data/bbs/team/M2412041116349_1.jpg')" alt="김혜지" /><div class="tit"><small class="eng">Professional</small><h4>김혜지</h4></div></dt>
	<dd>
		<div>
			 <ul>
				 <li></li>
				 <li>hyejikim@forestac.co.kr</li>
			 </ul>
			 <span class="more">Read More</span>
		</div>
	</dd>
...
<dl>
		<a href="/sub/team.php?ptype=view&idx=284&page=1&code=team">
	<dt><img src="/admin/bbs/skin/teamBasic/image/blank_img.png" style="background-image:url('/admin/data/bbs/team/M2410310203386_1.jpg')" alt="이수연" /><div class="tit"><small class="eng">Professional</small><h4>이수연</h4></div></dt>
	<dd>
		<div>
			 <ul>
				 <li>Due Diligence and Valuation</li>
				 <li>suyeonlee@forestac.co.kr</li>
			 </ul>
			 <span class="more">Read More</span>
		</div>
	</dd>
...
<dl>
		<a href="/sub/team.php?ptype=view&idx=294&page=1&code=team">
	<dt><img src="/admin/bbs/skin/teamBasic/image/blank_img.png" style="background-image:url('/admin/data/bbs/team/M2510310508535_1.jpg')" alt="백승호" /><div class="tit"><small class="eng">Professional</small><h4>백승호</h4></div></dt>
	<dd>
		<div>
			 <ul>
				 <li></li>
				 <li>seunghobaek@forestac.co.kr</li>
			 </ul>
			 <span class="more">Read More</span>
		</div>
	</dd>
...
<dl>
		<a href="/sub/team.php?ptype=view&idx=293&page=1&code=team">
	<dt><img src="/admin/bbs/skin/teamBasic/image/blank_img.png" style="background-image:url('/admin/data/bbs/team/M2510300554368_1.jpg')" alt="김창현" /><div class="tit"><small class="eng">Professional</small><h4>김창현</h4></div></dt>
	<dd>
		<div>
			 <ul>
				 <li>Valuation</li>
				 <li>chkim@forestac.co.kr</li>
			 </ul>
			 <span class="more">Read More</span>
		</div>
	</dd>
...
<dl>
		<a href="/sub/team.php?ptype=view&idx=285&page=1&code=team">
	<dt><img src="/admin/bbs/skin/teamBasic/image/blank_img.png" style="background-image:url('/admin/data/bbs/team/M2410310209476_1.jpg')" alt="이웅희" /><div class="tit"><small class="eng">Professional</small><h4>이웅희</h4></div></dt>
	<dd>
		<div>
			 <ul>
				 <li></li>
				 <li>woongheelee@forestac.co.kr</li>
			 </ul>
			 <span class="more">Read More</span>
		</div>
	</dd>
...
<dl>
		<a href="/sub/team.php?ptype=view&idx=287&page=1&code=team">
	<dt><img src="/admin/bbs/skin/teamBasic/image/blank_img.png" style="background-image:url('/admin/data/bbs/team/M2411181010592_1.jpg')" alt="이주연" /><div class="tit"><small class="eng">대리</small><h4>이주연</h4></div></dt>
	<dd>
		<div>
			 <ul>
				 <li>대리</li>
				 <li>juyeonlee@forestac.co.kr</li>
			 </ul>
			 <span class="more">Read More</span>
		</div>
	</dd>
...
<!-- 페이지 번호 -->
    <div class='page_num'><ul class='pagination'>
                     <li class='arrow'><a href='?page=1&code=team'><img src='/img/bbs_first.png' alt='처음'></a></li>
                     <li class='arrow'><a href='?page=1&code=team'><img src='/img/bbs_prev.png' alt='이전'></a></li>
                     <li><a href='javascript:;' class='active'>1</a></li>
                     <li class='arrow'><a href='?page=1&code=team'><img src='/img/bbs_next.png' alt='다음'></a></li>
                     <li class='arrow'><a href='?page=1&code=team'><img src='/img/bbs_last.png' alt='맨끝'></a></li>
                   </ul></div>
<!-- 페이지 번호끝 -->
...
<div class="bbs_btn">
  <ul>
  	<li class="sel_btn"></li>
    <li class="list_btn"><a href='/sub/team.php?ptype=list&code=team&' class='btn_w'>리스트</a></li>
  </ul>
</div>  
<!-- 버튼 끝 -->
</div>
