...
<script type='text/javascript' src='/comm/js/script.js?v=1774840737'></script>
...
<link rel="stylesheet" type="text/css" href="/comm/css/sub.css?v=1774840737" />
...
<!--[e] 모바일 menuArea -->
  		...
  		<!-- Visual -->
		<div id="visual">
			<div class="bg subtop_solution"></div>
			<h2>GROUNDBREAKING SOLUTION<span>FOREST is Korea's first advisory firm specializing in both valuation and financial advisory services</span></h2>
		</div> 
		<!--//Visual -->
...
<div class="solution_cont basicCont2 sub_effect"><script Language="JavaScript" src="/admin/js/lib2.js"></script>
<link href="/admin/bbs/skin/faqBasic/style.css" rel="stylesheet" type="text/css">
<!-- <script type="text/javascript">
	jQuery(document).ready(function($) {
		$(".faq_list dt").on("click", function(){		
			$(this).toggleClass("qStyle");
...
<script language="javascript">
	$(document).ready(function(){
		...
		$(".faq_list > dl > dt").click(function(){
			...
			$(".faq_list > dl > dt").not(this).next().slideUp(300);
			$(".faq_list > dl > dt").not(this).parents("dl").removeClass("show");
			return false;
		});
	});
</script>
...
<dl>
  <dt id="listBoard6"><a><span class="icon"><img src="/admin/data/bbs/solution/S2207050154544_1.png" alt="VALUATION"/></span>VALUATION</a></dt>
  <dd class="faq accordion-section-content" id="faq6">
	 <div class="txt">회사는 기업, 사업부문 및 무형자산과 같은 재무보고 목적의 평가뿐만 아니라 거래 목적의 평가 및 기업 내부적으로 최적의 의사결정 위한 가치 평가 서비스를 필요로 합니다. <br/> FOREST는 산업에 대한 풍부한 경험을 보유한 전문가들이 모여 다양한 가치평가 방법론과 리서치 툴을 이용한 자료 분석을 기반으로, 합리적이고 신뢰성 높은 가치평가 서비스 제공을 추구하고 있습니다.</div>
	 <div class="check_cont"><dl>
 <dt>재무보고관련 가치평가</dt>
 <dd>투자자산 공정가치 평가</dd>
 <dd>영업권, 무형자산, 투자주식 및 현금창출단위(CGU) 손상검사</dd>
<dd>사업결합에 따른 매수가격배분(PPA)</dd>
</dl>
<dl>
 <dt>거래 관련 가치평가</dt>
 <dd>기업 인수 및 매각 시 투자 대상 가치평가</dd>
 <dd>지배구조 개선 및 사업 재조정 등 내부 의사결정 지원을 위한 가치평가</dd>
</dl>
<dl>
 <dt>세무 목적 가치평가</dt>
 <dd>상증세법에 따른 비상장주식 1주당 평가액 산출</dd>
</dl>
<dl>
 <dt>법률 및 소송 지원 목적 가치평가</dt>
 <dd>자본시장법에 따른 분할, 합병 및 자산양수도 시 공정가치 산출</dd>
 <dd>소송 지원 목적의 가치평가</dd>
</dl></div>
    </dd>
</dl>
<dl>
  <dt id="listBoard5"><a><span class="icon"><img src="/admin/data/bbs/solution/S2207050228516_1.png" alt="DUE DILIGENCE"/></span>DUE DILIGENCE</a></dt>
  <dd class="faq accordion-section-content" id="faq5">
	 <div class="txt">FOREST는 풍부한 실사 경험과 노하우를 바탕으로 인수 및 매도를 추진함에 있어 고객이 최적의 의사결정을 할 수 있도록 지원하고 있습니다. <br/> M&A 대상 기업의 중요한 재무적 이슈를 사전에 파악하여, 인수자 입장에서는 합리적인 가격을 지불할 수 있도록 지원하고, 매도자 입장에서는 전략적인 대응이 가능하도록 지원합니다. 

</div>
	 <div class="check_cont"><dl>
 <dt>인수 실사 (Buy-side DD)</dt>
 <dd>가격 협상 이슈 파악</dd>
 <dd>인수대상 기업의 재무정보 파악 및 수익성 분석</dd>
 <dd>Deal breaking issue 파악
</dl>
dt>
<dl>
 <dt>매도 실사 (Sell-side DD)</dt>
 <dd>매각과정에서 제기될 수 있는 주요 이슈 사전 파악</dd>
 <dd>대상기업의 Up-side 파악</dd>
 <dd>인수자에게 목적적합한 재무정보 제공</dd>
</dl>
dt>
 </div>
    </dd>
...
<dl>
  <dt id="listBoard4"><a><span class="icon"><img src="/admin/data/bbs/solution/S2207050228372_1.png" alt="M&A ADVISORY"/></span>M&A ADVISORY</a></dt>
  <dd class="faq accordion-section-content" id="faq4">
	 <div class="txt">M&A 전문가들로 구성된 FOREST는 투자유치 및 M&A 전략 수립 단계부터 실사, 가치평가, 거래의 실행 단계까지 각 단계에서 발생할 수 있는 이슈를 해결하는 통합적인 자문서비스를 제공합니다. <br/> 특히 실사와 가치평가 업무의 효율적인 협력을 통해  Deal 이슈 파악과 거래가격 산정 서비스 제공을 통하여 고객의 전략적 의사결정을 지원하고 있습니다. </div>
	 <div class="check_cont"><dl>
 <dt>투자 유치 및 M&A 전략 수립 </dt>
</dl>
<dl>
 <dt>인수 실사 및 매각 실사</dt>
</dl>
...
<dl>
 <dt>인수 후 Value 창출을 위한 전략적 의사결정 지원</dt>
</dl>
</div>
    </dd>
</dl>
<dl>
  <dt id="listBoard3"><a><span class="icon"><img src="/admin/data/bbs/solution/S2207050228234_1.png" alt="DERIVATIVES"/></span>DERIVATIVES</a></dt>
  <dd class="faq accordion-section-content" id="faq3">
	 <div class="txt">최근 회사와 투자자들은 전통적인 방식의 투자보다는 다양하고 복잡한 방식의 투자를 선호하면서 국내외 파생금융상품 발행 규모가 급증하고 있습니다.<br/> 파생금융상품은 주식, 채권, 통화 등과 같은 기초자산의 가치 변동에 의해 그 가치가 결정되는 금융상품으로서, 계약 구조와 기초자산의 유형 및 거래 방법에 따라 구분되어 다양한 형태로 존재합니다. <br/> FOREST는 복잡하게 설계되어 있는 파생금융상품의 수익구조에 대해 이해하고, 세부 계약 조건을 명확하게 파악하여 발행자 또는 투자자가 필요한 가치평가 서비스를 제공하고 있습니다.</div>
	 <div class="check_cont"><dl>
 <dt>우선주</dt>
 <dd>상환전환우선주 (Redeemable Convertible Preferred Stock)</dd>
 <dd>전환우선주 (Convertible Preferred Stock)</dd>
</dl>
<dl>
 <dt>주식형 사채</dt>
 <dd>전환사채 (Convertible Bond)</dd>
 <dd>교환사채 (Exchangeable Bond)</dd>
 <dd>신주인수권부사채 (Bond with Warrant)</dd>
</dl>
<dl>
 <dt>기타</dt>
 <dd>주식매수선택권 (Stock Option)</dd>
 <dd>양도제한조건부주식 (Restricted Stock Units)</dd>
 <dd>기타 (주주간계약에 따른 옵션, CB에 대한 발행자 매도청구권, 풋백옵션 등)</dd>
</dl></div>
    </dd>
</dl>
<dl>
  <dt id="listBoard2"><a><span class="icon"><img src="/admin/data/bbs/solution/S2207050228061_1.png" alt="FEASIBILITY STUDY"/></span>FEASIBILITY STUDY</a></dt>
  <dd class="faq accordion-section-content" id="faq2">
	 <div class="txt">사업을 시행하기 전 특정 사업의 성공가능성에 대한 정보를 파악하기 위하여 사업추진능력, 기술성, 시장성, 경제성, 위험 정도를 분석하고 평가하는 과정이 필요합니다. <br/> 사업 타당성 검토는 운영 또는 사업기간의 이익을 통해 투자비를 회수하고 일정 이윤을 창출할 수 있는지를 판단하는 과정으로서, 해당 사업에 대한 명확한 분석/이해와 다양한 이슈 해결 능력 및 다방면의 경험을 필요로 합니다. <br/> 이 과정에서 FOREST는 투자, 재원 조달, 운영 등 모든 사항을 반영한 재무모델을 설계하고, 설계된 재무모델을 바탕으로 사업계획서를 작성하는 서비스를 제공하고 있습니다. 
</div>
	 <div class="check_cont"><dl>
 <dt>수익성 분석</dt>
 <dd>수익전망, 투자수익률, 손익분기점 분석, 원가 및 가격분석 등</dd>
</dl>
<dl>
 <dt>시장성 분석</dt>
 <dd>제품 미래 수요 예측, 시장조사 및 점유율 분석, 시장성평가, 판매 예측</dd>
</dl>
<dl>
 <dt>재무 분석</dt>
 <dd>추정 재무상태표(자산, 부채, 자본 추정), 추정 손익계산서(매출액, 매출원가, 판매비 및 관리비, 영업이익 추정)</dd>
</dl></div>
    </dd>
</dl>
<dl>
  <dt id="listBoard1"><a><span class="icon"><img src="/admin/data/bbs/solution/S2207050227524_1.png" alt="OTHER ADVISORY"/></span>OTHER ADVISORY</a></dt>
  <dd class="faq accordion-section-content" id="faq1">
	 <div class="txt">FOREST는 기업에 대한 교육 등 다양한 지원 업무를 통해 고객과 마주하고 있습니다.</div>
	 <div class="check_cont"><dl>
 <dt>교육지원</dt>
 <dd>주식, 파생상품 등 평가대상에 대한 가치평가 이론 및 실무 교육 제공</dd>
 <dd>풍부한 실무 경험 사례가 반영된 깊이 있는 교육 제공</dd>
</dl>
<dl>
 <dt>가치평가 업무 리뷰 및 대응</dt>
 <dd>외부의 공정가치 평가 보고서 상 주요 가정 및 방법론에 대한 검토를 수행함으로써 고객의 의사결정을 위한 자문 서비스 제공</dd>
 <dd>FOREST가 발행한 평가 보고서에 대하여 외부 감사인 검토 절차가 수행되는 경우, 가치평가 이론에 기반한 논리적인 대응을 성실하게 수행</dd>
</dl>
<dl>
 <dt>사업계획 작성 지원</dt>
 <dd>기존 또는 신규 사업에 대한 사업계획 작성 시 산업과 재무추정 경험과 지식이 풍부한 전문가가 사업계획 작성을 지원</dd>
</dl>
<dl>
 <dt>기타 자문</dt>
 <dd>풍부한 재무자문 경험에 기반하여  자본조달 및 사업 과정에서 발생하는 제반 이슈에 대한 분석 및 자문 서비스 제공</dd>
</dl></div>
    </dd>
</dl></div>
...
<!-- 페이지 번호 -->
    <div class='page_num'><ul class='pagination'>
                     <li class='arrow'><a href='?page=1&code=solution'><img src='/img/bbs_first.png' alt='처음'></a></li>
                     <li class='arrow'><a href='?page=1&code=solution'><img src='/img/bbs_prev.png' alt='이전'></a></li>
                     <li><a href='javascript:;' class='active'>1</a></li>
                     <li class='arrow'><a href='?page=1&code=solution'><img src='/img/bbs_next.png' alt='다음'></a></li>
                     <li class='arrow'><a href='?page=1&code=solution'><img src='/img/bbs_last.png' alt='맨끝'></a></li>
                   </ul></div>
<!-- 페이지 번호끝 -->
