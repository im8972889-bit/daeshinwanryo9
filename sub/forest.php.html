...
<script type='text/javascript' src='/comm/js/script.js?v=1774840677'></script>
...
<link rel="stylesheet" type="text/css" href="/comm/css/sub.css?v=1774840677" />
...
<div class="forest_cont swiper-container">
   <div class="forestCont_in swiper-wrapper">
      <section id="forest" class="swiper-slide">
         <div class="forest_in w1280">
            <h2 class="subTit">FOREST ACCOUNTING CORPORATION</h2>
            <span class="subTxt">KOREA's FIRST ADVISORY FIRM</span>
            <div class="txt">회계법인 숲은 2021년 서울에 설립된 국내 최초 <font class="ls0">FAS(Financial Advisory Services)</font> 전문 회계법인으로, <font class="ls0">Big4 Financial Advisory Service</font> 본부의 <font class="ls0">FAS</font>전문가들이<br /> 모여 설립하였으며, 국내 유수의 고객군과 다양한 산업에 대한 재무자문 경험을 가지고 있습니다. <font class="ls0">FOREST</font>는 <font class="ls0">Global Accounting Firm, Private Equity, SI</font> 등에서 쌓은 전문지식과<br /> 재무자문 경험, 네트워크를 보유하고 있으며, 규모가 아닌 전문성을 바탕으로 차별화된 시각에서 기업에 대한 심도 깊은 분석을 시행하고, 고객의 <font class="ls0">Needs</font>에 맞는 서비스를 제공합니다.</div>
            <ul>
               <li>
                  <div>
                     <small class="eng">Founded</small><strong class="effect">2021</strong><span>년</span>
                  </div>
               </li>
               <li>
                  <div>
                     <small class="eng">FAS experience</small>
                     <p>
                        <strong id="counter1" class="counter" data-count="100"></strong>+
                     </p>
                     <span>years</span>
                  </div>
               </li>
               <li>
                  <div>
                     <small class="eng">Professionals</small><strong id="counter2" class="counter" data-count="20"></strong><span>명</span>
                  </div>
               </li>
            </ul>
         </div>
      </section>
      <section id="wefollowed" class="swiper-slide">
         <div class="wefollowed_in w1280">
            <h2 class="subTit">FOREST ACCOUNTING CORPORATION</h2>
            <span class="subTxt">KOREA's FIRST ADVISORY FIRM</span>
            <div class="txt">
               <font class="ls0">FOREST</font>는 <font class="ls0">Global accounting firm</font>에서 경험한 전문성<font class="ls0">(Expertise)</font>을 바탕으로 고객의 <font class="ls0">Needs</font>에 맞는 차별화된 해결책<font class="ls0">(Solution)</font>을 제공하며,<br /> 고객에 대한 진정성<font class="ls0">(Trust)</font>과 배려, 합리적인 가격으로 최상의 결과를 제공하고 있습니다.
            </div>
            <div class="wefollowed_roll">
               <dl class="roll">
                  <dt style="background-image:url('/sub/img/forest_roll01.jpg');"></dt>
                  <dd>
                     <span>01</span>
                     <h4>조직문화 동반성장, 구성원의 목소리 경청</h4>
                     <p>FOREST는 구성원 한명한명의 목소리에 귀를 기울이며 직급간 경계를 허물고,<br />자율성을 보장하는 소통의 문화를 지향합니다.</p>
                  </dd>
               </dl>
               <dl class="roll">
                  <dt style="background-image:url('/sub/img/forest_roll02.jpg');"></dt>
                  <dd>
                     <span>02</span>
                     <h4>회계/자본시장 회계투명성 및 자본시장 공정성 제고</h4>
                     <p>FOREST는 전문가적 역량과 윤리성을 바탕으로 사회적 투명성을 제고하고, <br />회계 투명성과 자본시장의 공정성을 확립하는데 기여하고 있습니다.</p>
                  </dd>
               </dl>
               <dl class="roll">
                  <dt style="background-image:url('/sub/img/forest_roll03.jpg');"></dt>
                  <dd>
                     <span>03</span>
                     <h4>사회적 책임(CSR) 준수</h4>
                     <p>FOREST는 매년 매출액의 일정부분을 사회에 환원하고 공익활동을 수행하며 기업의 사회적 책임을 위해 최선을 다하고 있습니다.</p>
                  </dd>
               </dl>
            </div>
         </div>
   ...
   <div class="forestCont_in swiper-wrapper">
      <section id="forest" class="swiper-slide">
         <div class="forest_in w1280">
            ...
            <ul>
               <li>
                  <div><small class="eng">Founded</small><strong class="effect">2021</strong><span>년</span></div>
                  </li>
               <li>
                  <div><small class="eng">FAS experience</small>
                     <p><strong id="counter1" class="counter" data-count="100"></strong>+</p>
                     <span>year</span></div>
                  </li>
               <li>
                  <div><small class="eng">Professionals</small><strong id="counter2" class="counter" data-count="13"></strong><span>명</span></div>
                  </li>
               </ul>
            </div>
         </section>
      ...
      <section id="wefollowed" class="swiper-slide">
         <div class="wefollowed_in w1280">
            <h2 class="subTit">FOREST ACCOUNTING CORPORATION</h2>
            <span class="subTxt">KOREA's FIRST ADVISORY FIRM</span>
            <div class="txt"><font class="ls0">FOREST</font>는 <font class="ls0">Global accounting firm</font>에서 경험한 전문성<font class="ls0">(Expertise)</font>을 바탕으로 고객의 <font class="ls0">Needs</font>에 맞는 차별화된 해결책<font class="ls0">(Solution)</font>을 제공하며,<br/> 고객에 대한 진정성<font class="ls0">(Trust)</font>과 배려, 합리적인 가격으로 최상의 결과를 제공하고 있습니다.</div>
            <div class="wefollowed_roll">
               <dl class="roll"><dt style="background-image:url('/sub/img/forest_roll01.jpg');"></dt>
                  <dd><span>01</span>
                     <h4>조직문화 동반성장, 구성원의 목소리 경청</h4>
                     <p>FOREST는 구성원 한명한명의 목소리에 귀를 기울이며 직급간 경계를 허물고,<br />자율성을 보장하는 소통의 문화를 지향합니다.</p>
                     </dd>
                  </dl>
               <dl class="roll"><dt style="background-image:url('/sub/img/forest_roll02.jpg');"></dt>
                  <dd><span>02</span>
                     <h4>회계/자본시장 회계투명성 및 자본시장 공정성 제고</h4>
                     <p>FOREST는 전문가적 역량과 윤리성을 바탕으로 사회적 투명성을 제고하고, <br />회계 투명성과 자본시장의 공정성을 확립하는데 기여하고 있습니다.</p>
                     </dd>
                  </dl>
               <dl class="roll"><dt style="background-image:url('/sub/img/forest_roll03.jpg');"></dt>
                  <dd><span>03</span>
                     <h4>사회적 책임(CSR) 준수</h4>
                     <p>FOREST는 매년 매출액의 일정부분을 사회에 환원하고 공익활동을 수행하며 기업의 사회적 책임을 위해 최선을 다하고 있습니다.</p>
                     </dd>
...
<style>
 @property --num {
  ...
  initial-value: 0;
	...
	.action #counter1::before {
		counter-reset: my-counter var(--num);
		content: counter(my-counter);
		animation: count 2.2s ease-in-out forwards;
	}
	...
	.action #counter2::before {
		counter-reset: my-counter2 var(--num2);
		content: counter(my-counter2);
		animation: count2 2.2s ease-in-out forwards;
	}

	
@keyframes count {to { --num: 100; }}
@keyframes count2 {to { --num2: 20; }}
</style>
