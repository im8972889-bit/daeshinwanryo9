...
<script type='text/javascript' src='/comm/js/script.js?v=1774840806'></script>
...
<link rel="stylesheet" type="text/css" href="/comm/css/sub.css?v=1774840806" />
...
<!--[e] 모바일 menuArea -->
  		...
  		<!-- Visual -->
		<div id="visual">
			<div class="bg subtop_privacy"></div>
			<h2>USER GIUDE<span>Forest privacy policy</span></h2>
		</div> 
		<!--//Visual -->
...
<div class="policy_con basicCont2">
	      "회계법인 숲"은 (이하 "회사"는) 고객님의 개인정보를 중요시하며, "정보통신망 이용촉진 및 정보보호"에 관한 법률을 준수하고 있습니다.
				우리 회사는 개인정보처리방침을 통하여 고객님께서 제공하시는 개인정보가 어떠한 용도와 방식으로 이용되고 있으며, 개인정보보호를 위해 어떠한 조치가 취해지고 있는지 알려드립니다.<br />
				우리 회사는 개인정보처리방침을 개정하는 경우 웹사이트 공지사항(또는 개별공지)을 통하여 공지할 것입니다.<br /><br />
본 방침은 : 2020년 12월 15일 부터 시행됩니다.<br /><br />
				...
				<a name="num1"></a>
				<p class="cont_tit">수집하는 개인정보 항목 </p>
				<div class="cont_txt">
					우리 회사는 Contact 등을 위해 아래와 같은 개인정보를 수집하고 있습니다.

					<div class="cont_box"> 
						<strong>수집항목</strong><br /> 
						접속기록, 자기소개서, 이력서, 쿠키 등<br /><br />
				        <strong>개인정보 수집방법</strong><br />홈페이지(Contact)				  </div>
					</div>

				<a name="num2"></a>
				<p class="cont_tit">개인정보의 수집 및 이용목적 </p>
				<div class="cont_txt">
					...
					<div class="cont_box">
						...
						<strong>이용자 관리</strong><br />
						이용에 따른 본인확인 , 개인 식별 , 불량이용자의 부정 이용 방지와 비인가 사용 방지 , 가입 의사 확인 , 연령확인 , 불만처리 등 민원처리 , 고지사항 전달 <br /><br />

						<strong>마케팅 및 광고에 활용</strong><br />
						이벤트 등 광고성 정보 전달 , 접속 빈도 파악 또는 이용자의 서비스 이용에 대한 통계
					</div>
				</div>
				 
				<a name="num3"></a>
				<p class="cont_tit">개인정보의 보유 및 이용기간</p> 
				<div class="cont_txt">
					원칙적으로, 개인정보 수집 및 이용목적이 달성된 후에는 해당 정보를 지체 없이 파기합니다. 단, 관계법령의 규정에 의하여 보존할 필요가 있는 경우 회사는 아래와 같이 관계법령에서 정한 일정한 기간 동안 이용자정보를 보관합니다. 
...
<!-- 						- 보존 항목 : 결제기록<br /> -->
				...
				<a name="num4"></a>
				<p class="cont_tit">개인정보의 파기절차 및 방법 </p>
				<div class="cont_txt">
				    ...
				    <strong>파기절차</strong><br />
						이용자님이 이용자가입 등을 위해 입력하신 정보는 목적이 달성된 후 별도의 DB로 옮겨져(종이의 경우 별도의 서류함) 내부 방침 및 기타 관련 법령에 의한 정보보호 사유에 따라(보유 및 이용기간 참조) 일정 기간 저장된 후 파기되어 집니다. <br />
				...
				<a name="num6"></a>
				<p class="cont_tit">수집한 개인정보의 위탁 </p>
				<div class="cont_txt">
				...
				<a name="num7"></a>
				<p class="cont_tit">정보주체와 법정대리인의 권리 및 의무 및 행사방법</p>
				<div class="cont_txt">
					정보주체는 회사에 대해 언제든지 다음 각 호의 개인정보 보호 관련 권리를 행사할 수 있습니다.
					<div class="cont_box">
						고객서비스담당 부서 : 고객지원부<br /><br />
						1. 개인정보 열람요구<br />
				...
				<a name="num8"></a>
				<p class="cont_tit">개인정보 자동수집 장치의 설치, 운영, 거부</p>
				<div class="cont_txt">
					...
					<div class="cont_box">
						...
						쿠키를 통해 이용자가 선호하는 설정 등을 저장하여 이용자에게 보다 빠른 웹 환경을 지원하며, 편리한 이용을 위해 서비스 개선에 활용합니다. 이를 통해 이용자는 보다 손쉽게 서비스를 이용할 수 있게 됩니다.<br /><br />


						<strong>▶ 쿠키를 수집하지 못하게 거부하고 싶다면? </strong> <br />
						이용자는 쿠키 설치에 대한 선택권을 가지고 있습니다. 따라서, 이용자는 웹 브라우저에서 옵션을 설정함으로써 모든 쿠키를 허용하거나, 쿠키가 저장될 때마다 확인을 거치거나, 모든 쿠키의 저장을 거부할 수도 있습니다. 다만 쿠키 설치를 거부할 경우 웹 사용이 불편해지며 로그인이 필요한 일부 서비스 이용에 어려움이 있을 수 있습니다.<br /><br />
				...
				<a name="num9"></a>
				<p class="cont_tit">개인정보에 관한 민원서비스</p>
				<div class="cont_txt">
					우리 회사는 고객의 개인정보를 보호하고 개인정보와 관련한 불만을 처리하기 위하여 아래와 같이 관련 부서 및 개인정보관리책임자를 지정하고 있습니다. <br />

					<div class="cont_box">
						고객서비스담당 부서 : 고객지원부<br />
						전화번호 : 02-6954-2500 <br />
						이메일 : FORESTac@forestac.co.kr<br /><br />

						개인정보관리책임자 성명 : 김재훈<br />
						전화번호 : 02-6954-2500<br />
						이메일 :  FORESTac@forestac.co.kr					</div>
					<br />
